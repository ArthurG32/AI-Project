...
public class GeneticAlgorithm {
	...
	private static final int HIDDENLAYERS = 4; // alterar aqui o n�mero de n�s hidden layer que queremos- ir testando
	...
	public double simulateGame(NeuralNetwork network) {
		BreakoutBoard breakoutBoard = new BreakoutBoard(network, false, 1); // este 1 � o valor da seed
